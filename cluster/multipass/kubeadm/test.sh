...
kubectl run test-nginx --image=busybox --restart=Never -l test=true --rm -it --command -- wget -O- --server-response --timeout=2 http://nginx-cip.default.svc.cluster.local:8080
